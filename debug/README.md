...
命令很多，提供帮助手册
```shell
curl http://localhost:xxx/{api-prefix}/debug/help
```
...
```json
{
  ...
  "3.-": "===================【接口出入参】===========================================================================================================================================================",
  "3.1 指定url打印请求": "--------------: curl -X PUT http://localhost:8080/api/demo/config/update -d '{\"key\":\"gole.server.http.request.print.include-uri[0]\", \"value\":\"/api/xx/xxx\"}'",
  "3.2 指定url不打印请求": "------------: curl -X PUT http://localhost:8080/api/demo/config/update -d '{\"key\":\"gole.server.http.request.print.exclude-uri[0]\", \"value\":\"/api/xx/xxx\"}'",
  "3.3 指定url打印请求和响应": "---------: curl -X PUT http://localhost:8080/api/demo/config/update -d '{\"key\":\"gole.server.http.response.print.include-uri[0]\", \"value\":\"/api/xx/xxx\"}'",
  "3.4 指定url不打印请求和响应": "-------: curl -X PUT http://localhost:8080/api/demo/config/update -d '{\"key\":\"gole.server.http.response.print.exclude-uri[0]\", \"value\":\"/api/xx/xxx\"}'",
  "4.-": "===================【bean管理】============================================================================================================================================================",
  ...
  "5.-": "=====================【pprof】============================================================================================================================================================",
  "5.1 动态启用pprof": "---------------: curl -X PUT http://localhost:8080/api/demo/config/update -d '{\"key\":\"gole.server.http.pprof.enable\", \"value\":\"true\"}'",
  "6.-": "===================【配置处理】=============================================================================================================================================================",
...
```shell
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.logger.level", "value":"debug"}'
```
...
```shell
# 指定要打印的请求的uri
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.include-uri[0]", "value":"/api/xx/xxx"}'
# 指定不要打印的请求uri
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.exclude-uri[0]", "value":"/api/xx/xxx"}'

# 指定要打印的响应的uri
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.response.print.include-uri[0]", "value":"/api/xx/xxx"}'
# 指定不要打印的响应uri
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.response.print.exclude-uri[0]", "value":"/api/xx/xxx"}'
```
...
```shell
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.include-uri[0]", "value":"/api/xx/xxx"}'
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.include-uri[1]", "value":"/api/xx/xxy"}'
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.include-uri[2]", "value":"/api/xx/xxz"}'
...
```
### 开启打印
...
```shell
# 开启请求的打印
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.enable", "value":"true"}'
# 开启响应的打印
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.request.print.enable", "value":"true"}'
# 开启异常的打印
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.exception.print.enable", "value":"true"}'
```
## 4. 动态管理bean
...
```shell
# 获取注册的所有bean
curl http://localhost:xxx/{api-prefix}/bean/name/all'
# 查询注册的某些bean 
curl http://localhost:xxx/{api-prefix}/bean/name/list/:name'
# 查询某个bean的属性值
curl -X POST http://localhost:xxx/{api-prefix}/bean/field/get' -d '{"bean": "xx", "field": "xxx"}'
# 修改某个bean的属性的值
curl -X PUT http://localhost:xxx/{api-prefix}/bean/field/set' -d '{"bean": "xx", "field": "xxx", "value": "xxx"}'
# 调用bean的某个函数
curl -X POST http://localhost:xxx/{api-prefix}/bean/fun/call' -d '{"bean": "xx", "fun": "xxx", "parameter": {"p1":"xx", "p2": "xxx"}}'
```
...
```shell
# 开启pprof
curl -X PUT http://localhost:xxx/{api-prefix}/config/update -d '{"key":"gole.server.http.pprof.enable", "value":"true"}'
```
